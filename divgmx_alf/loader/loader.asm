...
; 060000 MENU    16K	8 pages
; 06C000 OS'82   16K
;                96K
; 080000 ELF1	256K	16 pages
...
;	out (c),a
	...
	xor a			; открываем страницу озу #0
spi_loader3
	ld bc,#007f
	out (c),a
	ld hl,#c000
...
str1	
	db 23,0,0,17,#47,"DivGMX (Ultimate) Rev.A",17,7,13,13
	db "FPGA SoftCore - ALF TV GAME",13
	db "(build 20180407) By MVV",13,13
str8
	db "ASP configuration device ID 0x",0	; EPCS1	0x10 (1 Mb), EPCS4 0x12 (4 Mb), EPCS16 0x14 (16 Mb), EPCS64 0x16 (64 Mb)
str9
	db 23,0,6,"Copying data from FLASH...",0
str2
	db 23,0,8,"DDC data read...",0
str3
